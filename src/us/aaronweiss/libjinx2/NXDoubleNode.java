...
/**
 * An <code>NXNode</code> containing a double-precision integer.
 * @author Aaron Weiss
 * @version 1.0
 * @since 1.0
 */
public class NXDoubleNode extends NXNode {
	/**
	 * Creates an <code>NXNode</code> for a double-precision integer.
	 * @param name the name of the node
	 * @param value the value of the node
	 * @param file the file of the node
	 * @param parent the parent of the node
	 */
	public NXDoubleNode(String name, Double value, NXFile file, INXNode parent) {
