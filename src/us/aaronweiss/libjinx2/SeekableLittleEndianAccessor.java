...
/**
 * A seekable accessor of the little endian byte order.
 * @author Aaron Weiss
 * @version 1.0
 * @since 1.0
 * @see org.angelsl.ms.libjinx.LittleEndianReader
 */
public class SeekableLittleEndianAccessor {
	...
	/**
	 * Gets this accessor as a UTF-8 String.
	 * @return this accessor read out as a <code>String</code>
	 */
	 ...
	 */
	public void seek(long offset) throws NXException {
		if (offset > Integer.MAX_VALUE) {
			throw new NXException("Unable to seek to the specified offset due to integer limitations.");
		}
